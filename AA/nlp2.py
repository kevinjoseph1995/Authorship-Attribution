...
sequence_input = Input(shape=(1, MAX_SEQUENCE_LENGTH, ), dtype='int32')
embedded_sequences = embedding_layer(sequence_input)
print embedded_sequences.shape
x = Conv2D(128, 5, activation='relu', data_format='channels_first', input_shape=(1,1000,100))(embedded_sequences)
x = MaxPooling2D(5)(x)
x = Conv2D(128, 5, activation='relu', data_format='channels_first')(x)
x = MaxPooling2D(5)(x)
x = Conv2D(128, 5, activation='relu', data_format='channels_first')(x)
x = MaxPooling2D(35)(x)  # global max pooling
x = Flatten()(x)
